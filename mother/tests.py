...
class MotherModelTest(TestCase):
    def setUp(self):
        """
        Set up a sample Mother instance for testing with a related Hospital instance.
        """
        # Create a hospital instance first (since Mother has a ForeignKey to Hospital)

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel_no', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be between 10 and 15 digits and start with '+'", regex='^\\+?\\d{10,15}$')])),

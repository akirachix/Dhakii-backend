...
from django.contrib.auth import get_user_model  # For creating a User instance
...
class ScreeningTestScoreModelTest(TestCase):
    def setUp(self):
        ...
        # Create a Mother instance with correct fields
        ...
        # Create a CHP instance with correct fields, including a valid User
        self.chp = CHP.objects.create(
            user=self.user,  # Provide the valid User instance here
